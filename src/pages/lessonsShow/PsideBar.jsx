  ...
  return (
    ...
    <ul  className="nav nav-pills flex-column ">
      <li style={{ height:98,   position: 'relative' , left:44 , marginBottom:-20 , marginTop: -13.8 }}  className="nav-item">
        <NavLink id='home' to='/projects/contents/part1' style={{ height: 50 , width:170 ,fontFamily: 'Markazi Text' , fontWeight: '200' , fontSize: '1.4rem'}} className="nav-link text-white" aria-current="page">
<span style={{position: 'relative' , left: -12 , color:'black'}}>
  الجزء الأول
      ...
      <li style={{ height:98,   position: 'relative' , left:44 , marginBottom:-18 , marginTop: -23 }}>
        <NavLink id='projects' to="/projects/contents/part2" style={{ height: 50 , width:170 ,fontFamily: 'Markazi Text' , fontWeight: '200' , fontSize: '1.4rem'}} href="#" className="nav-link text-white">
      ...
      <li style={{ height:100,   position: 'relative' , bottom:0 , left:44 , marginBottom:-18 , marginTop: -25 }}>
        <NavLink id='projects' to='/projects/contents/part3' style={{ height: 50 , width:170 ,fontFamily: 'Markazi Text' , fontWeight: '200' , fontSize: '1.4rem'}} href="#" className="nav-link text-white">
<span style={{position: 'relative' , left: -12 ,color: 'black'}}>
  ...
  الجزء الثالث
      ...
      <li style={{ height:100,   position: 'relative' , bottom:0 , left:44 , marginBottom:-18 , marginTop: -26 }}>
        <NavLink id='devices' to='/projects/contents/part4' style={{ height: 50 , width:170 ,fontFamily: 'Markazi Text' , fontWeight: '200' , fontSize: '1.4rem'}} href="#" className="nav-link text-white">
<span style={{position: 'relative' , left: -12 , color: 'black'}}>
      ...
      <li style={{ height:100,   position: 'relative' , bottom:0 , left:44 , marginBottom:-18 , marginTop: -28 }}>
        <NavLink id='devices' to='/projects/contents/part5' style={{ height: 50 , width:170 ,fontFamily: 'Markazi Text' , fontWeight: '200' , fontSize: '1.4rem'}} href="#" className="nav-link text-white">
<span style={{position: 'relative' , left: -12 , color: 'black'}}>
